...
const String node_id  = "NODE_001"; // Use NODE_001 for Kitchen, NODE_002 for Bedroom
const String location = "Kitchen";  // Use Kitchen or Bedroom

// STATIC IP CONFIGURATION
IPAddress local_IP(192, 168, 1, 101); // 101 for Kitchen, 102 for Bedroom
